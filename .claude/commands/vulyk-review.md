...
4. On `BLOCK`: convert each critical finding into a fix story in the same spec directory and route back through `/vulyk-build`. Do not hand-patch criticals in the main session - fixes stay in the cascade.
